...
public class ListDialog extends Dialog{
    ...
    // Done
    /*
        // сделать лейаут диалога 2 - ентри
        // сделать Энтри в БД или БД для этого ????????????
        // добавить Гоалу поле / к какому листу относится /
        // сделать 2 дефолтных листа - DOING / DONE
        // дать возможность добавлять гоал либо в один либо в другой лист
        // дать возможность показывать определенный лист
